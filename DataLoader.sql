...
insert  into `customers`(`customer_number`,`customer_name`,`contactLastName`,`contactFirstName`,`phone`,`addressLine1`,`addressLine2`,`city`,`state`,`postal_code`,`country`,`salesRepEmployeeNumber`,`creditLimit`) values 
...
insert  into `offices`(`officeCode`,`city`,`phone`,`addressLine1`,`addressLine2`,`state`,`country`,`postal_code`,`territory`) values 
...
insert  into `orderdetails`(`order_number`,`product_code`,`quantity_ordered`,`priceEach`,`orderLineNumber`) values 
...
insert  into `products`(`product_code`,`product_name`,`productLine`,`productScale`,`product_vendor`,`product_description`,`quantity_in_stock`,`buyPrice`,`MSRP`) values 
